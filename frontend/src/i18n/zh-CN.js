export default {
  ...
  organization: {
    ...
    integration: {
      ...
      jira_url: 'JIRA 地址',
      yunxiao_url: '天玑地址',
      yunxiao_interface_url: '天玑接口地址',
      jira_issuetype: '问题类型',
      jira_storytype: '需求类型',
      input_api_account: '请输入账号',
      input_api_password: '请输入密码',
      input_jira_url: '请输入Jira地址，例：https://metersphere.atlassian.net/',
      input_yunxiao_url: '请输入Yunxiao地址，例：https://metersphere.atlassian.net/',
      input_yunxiao_interface_url: '请输入Yunxiao接口地址，例：https://metersphere.atlassian.net/',
      input_jira_issuetype: '请输入问题类型',
      input_yunxiao_issuetype: '请输入问题类型',
      input_jira_storytype: '请输入需求类型',
      input_yunxiao_storytype: '请输入需求类型',
      zentao_url: '地址',
      zentao_request: '请求方式',
  ...
  load_test: {
    ...
    update_threadgroup_confirm: '确认批量更新git存储库中文件',
    scenario_list: '场景列表',
    scenario_name: "场景名称",
    report_type: "报告类型",
