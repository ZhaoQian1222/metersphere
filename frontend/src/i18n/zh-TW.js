export default {
  ...
  load_test: {
    ...
    update_threadgroup_confirm: '確認批量更新git存儲庫中文件',
    scenario_list: '場景列表',
    scenario_name: "場景名稱",
    report_type: "报告类型",
  ...
  ui: {
    ...
    wait_time: "等待時間",
    per_tip: "啟用性能模式後，將減少內存和cpu的占用，運行結果不展示步驟截圖",
    fail_over: "失敗終止",
    ...
    like_string_tip2: "注意：作為對像類型存儲時如果不是一個合法的 js 對像類型（如非法特殊字符、空格影響），可能會生成報告失敗。",
    ele_pro: "元素屬性",
