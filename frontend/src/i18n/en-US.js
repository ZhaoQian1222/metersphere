export default {
  ...
  load_test: {
    ...
    update_threadgroup_confirm: 'Confirm update Git File',
  ...
  api_test: {
    ...
    automation: {
      ...
      batch_updateCsvFile:"Batch update",
      scenario: {
        principal: "principal",
  ...
  ui: {
    ...
    wait_time: "Wait Time",
    per_tip: "Performance mode , reduce the useage of CPU and Memory, will not screenshot",
    fail_over: "If Fail Terminate Test",
    validate_tip: "Check for assert. If the assertion fails, the program will terminate. Unchecked indicates soft assertion. If the assertion fails, the program does not terminate. .The following scenario is the following:",
    extract_type: "Select extract_type",
    input_handle_name: "Please enter the Handle variable name of the storage window ",
    extract_tip: "Save the extracted content to a variable ",
    input_window_title: "Please enter the name of the stored page title variable ",
    browser: "browser",
    validate_type: "Validate Type",
    expect_value: "Expected Value",
    expect_title: "Expected Title ",
    title_tip: "Asserts whether the title of the current window is as expected. If it matches exactly, the claim succeeds, otherwise it fails ",
    input_var: "Please enter variables ",
    input_expect: "Please enter the expected value ",
    var_tip: "asserts whether the variable matches the expected value ",
    confirm_after_success: "Click the Confirm button after success ",
    input_expect_text: "Please enter the expected popover text ",
    input_window_tip: "supports assertions of popover text only. If yes, the assertion succeeds and the Confirm button on the popover is clicked. If no, the assertion succeeds and no button is clicked.",
    select_value: "select_value: the value of the selected element is equal to the expectation (SelectedValue)",
    select_label: "drop-down box option displays text equal to expectation (SelectedLabel) ",
    not_select_value: "The value of the selected element is not equal to the expectation (NotSelectedValue) ",
    assert_check: "Checked ",
    assert_editable: "Editable ",
    assert_element_present: "Element exists (ElementPresent)",
    assert_element_not_present: "Element does not exist (ElementNotPresent)",
    assert_element_not_checked: "Element not checked (NotChecked)",
    assert_element_not_editable: "Element is not editable (NotEditable)",
    assert_element_not_text: "Element text not equal to expected (NotText)",
    assert_text: "Element Text equals expected (Text)",
    assert_value: "The element Value is equal to the expected value",
    script_tip: "only js scripts are supported, the set script will be executed in the browser ",
